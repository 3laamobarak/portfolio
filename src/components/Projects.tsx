...
export function Projects() {import { motion, useInView } from "framer-motion";
import { useRef } from "react";
import { Github, ShoppingCart, Utensils, Heart, Store, Globe, Code, ShoppingBag } from "lucide-react";

const projects = [
  {
    title: "Tamm Store — Kuwait",
    year: "2026",
    description: "End-to-end Shopify build for a Kuwait multi-category retailer: a fully architected storefront on a customized Cargo theme, powered by a 3-level metaobject category system driving 94 collections across electronics, appliances, automotive and more.",
    tech: ["Shopify", "Liquid", "Metaobjects", "Metafields", "Multi-currency", "i18n (AR/EN)", "SEO"],
    highlights: [
      "Custom 3-level taxonomy (Main → Sub → Baby) via metaobjects",
      "94 collections — 74 smart/automated + manual merchandising",
      "26 apps integrated: dropshipping, loyalty, PIM & translation",
      "Bilingual (Arabic/English) with multi-currency conversion",
      "Custom metafields: dimensions, warranty & countdown timers"
    ],
    icon: ShoppingBag,
    live: true,
    demo: "https://tammstore.com/",
  },
  {
    title: "iHerb Backend",
    year: "2026",
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {project.live && (
                          <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-emerald-500/10 text-emerald-500 border border-emerald-500/30">
